...
grant usage on *.* to 'cairis_test'@'%' identified by 'cairis_test' with max_queries_per_hour 0 max_connections_per_hour 0 max_updates_per_hour 0 max_user_connections 0;
flush privileges;

drop database if exists `cairis_test`;
