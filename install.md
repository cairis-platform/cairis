...
A live demo of CAIRIS is available to use on http://demo.cairis.org.  The username and password you need are *test* and *test*.  The live demo is rebuilt every night based on the latest updates to CAIRIS.
