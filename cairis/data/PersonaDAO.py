...
from cairis.tools.ModelDefinitions import AssetModel, AssetEnvironmentPropertiesModel
...
class AssetDAO(CairisDAO):
    ...
    def get_persona(self, constraint_id=-1, simplify=True):
        """
        ...
        """
        try:
            persona = self.db_proxy.getPersona(constraint_id)
