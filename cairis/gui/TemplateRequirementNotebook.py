...
class SummaryPage(wx.Panel):
  def __init__(self,parent):
    ...
    self.nameCtrl = wx.TextCtrl(self,TEMPLATEREQUIREMENT_TEXTNAME_ID,'')
    ...
    self.assetCtrl = wx.ComboBox(self,TEMPLATEREQUIREMENT_COMBOASSET_ID,choices=assets,size=wx.DefaultSize,style=wx.CB_READONLY)
    ...
    self.typeCtrl = wx.ComboBox(self,TEMPLATEREQUIREMENT_COMBOTYPE_ID,choices=typeChoices,size=wx.DefaultSize,style=wx.CB_READONLY)
    ...
    self.descriptionCtrl = wx.TextCtrl(self,TEMPLATEREQUIREMENT_TEXTDESCRIPTION_ID,'',style=wx.TE_MULTILINE)
...
class TemplateRequirementNotebook(wx.Notebook):
  def __init__(self,parent):
    wx.Notebook.__init__(self,parent,TEMPLATEREQUIREMENT_NOTEBOOKREQUIREMENT_ID)
    p1 = SummaryPage(self)
    p2 = MLTextPage(self,TEMPLATEREQUIREMENT_TEXTRATIONALE_ID)
    p3 = MLTextPage(self,TEMPLATEREQUIREMENT_TEXTFITCRITERION_ID)
