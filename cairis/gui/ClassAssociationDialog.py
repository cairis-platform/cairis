...
class ClassAssociationDialog(wx.Dialog):
  ...
  def load(self,association):
    ...
    envCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOENVIRONMENT_ID)
    headCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOHEADASSET_ID)
    headNavCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOHEADNAV_ID)
    headTypeCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOHEADTYPE_ID)
    headMultiplicityCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOHEADMULTIPLICITY_ID)
    headRoleCtrl = self.FindWindowById(CLASSASSOCIATION_TEXTHEADROLE_ID)
    tailRoleCtrl = self.FindWindowById(CLASSASSOCIATION_TEXTTAILROLE_ID)
    tailMultiplicityCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOTAILMULTIPLICITY_ID)
    tailTypeCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOTAILTYPE_ID)
    tailNavCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOTAILNAV_ID)
    tailCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOTAILASSET_ID)
    buttonCtrl = self.FindWindowById(CLASSASSOCIATION_BUTTONCOMMIT_ID)
  ...
  def onCommit(self,evt):
    ...
    if len(self.theEnvironmentName) == 0:
      ...
      self.EndModal(CLASSASSOCIATION_BUTTONCOMMIT_ID)
  ...
  def onEnvironmentChange(self,evt):
    ...
    headMultiplicityCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOHEADMULTIPLICITY_ID)
    headRoleCtrl = self.FindWindowById(CLASSASSOCIATION_TEXTHEADROLE_ID)
    tailRoleCtrl = self.FindWindowById(CLASSASSOCIATION_TEXTHEADROLE_ID)
    tailMultiplicityCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOTAILMULTIPLICITY_ID)
    tailTypeCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOHEADTYPE_ID)
    tailNavCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOTAILNAV_ID)
    tailCtrl = self.FindWindowById(CLASSASSOCIATION_COMBOTAILASSET_ID)
