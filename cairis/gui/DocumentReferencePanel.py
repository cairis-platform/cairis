...
class DocumentReferencePanel(BasePanel):
  def __init__(self,parent):
    BasePanel.__init__(self,parent,DOCUMENTREFERENCE_ID)
    self.theId = None
    b = Borg()
  ...
  def buildControls(self,isCreate,isUpdateable=True):
    ...
    mainSizer.Add(self.buildTextSizer('Name',(87,30),DOCUMENTREFERENCE_TEXTNAME_ID),0,wx.EXPAND)

    docs = self.dbProxy.getDimensionNames('external_document')
    mainSizer.Add(self.buildComboSizerList('Document',(87,30),DOCUMENTREFERENCE_COMBODOCNAME_ID,docs),0,wx.EXPAND)

    mainSizer.Add(self.buildTextSizer('Contributor',(87,30),DOCUMENTREFERENCE_TEXTCONTRIBUTOR_ID),0,wx.EXPAND)

    mainSizer.Add(self.buildMLTextSizer('Excerpt',(87,30),DOCUMENTREFERENCE_TEXTEXCERPT_ID),1,wx.EXPAND)
    mainSizer.Add(self.buildCommitButtonSizer(DOCUMENTREFERENCE_BUTTONCOMMIT_ID,isCreate),0,wx.CENTER)
