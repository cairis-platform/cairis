...
from cairis.tools.MessageDefinitions import PersonaMessage
from cairis.tools.ModelDefinitions import PersonaModel
from cairis.tools.SessionValidator import get_session_id
from cairis.tools.JsonConverter import json_serialize


__author__ = 'Rachel Larcombe'


class PersonaAPI(Resource):
    # region Swagger Doc
    @swagger.operation(
        notes='Get all Persona Details',
        nickname='persona-get',
        responseClass=PersonaRequirementModel.__name__,
    ...
    def get(self):
        ...
        reqs = dao.get_persona(constraint_id=constraint_id, ordered=(ordered=='1'))
        dao.close()
