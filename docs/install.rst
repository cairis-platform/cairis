...
.. code-block:: bash
   ...
   sudo docker run --name cairis-mysql -e MYSQL_ROOT_PASSWORD=my-secret-pw -d mysql:lts --thread_stack=256K --max_sp_recursion_depth=255 --log_bin_trust_function_creators=1
