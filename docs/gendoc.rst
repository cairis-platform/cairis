...
menu.  After choosing the type of specification, the output file name, and the output type (PDF or RTF), clicking on Generate will generate and download the specification document.
