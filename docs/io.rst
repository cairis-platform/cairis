...
You will usually want to stick with the Model Package option to import .cairis files.  .cairis files are zip archives with a model file (model.xml) and all the image files associated with the model.  
